<%@ Page Title="" Language="C#" MasterPageFile="~/MemberPage.master" AutoEventWireup="true" CodeFile="feedback1.aspx.cs" Inherits="feedback1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <center> <asp:Panel ID="Panel1" runat="server" BackColor="white"  Height="110%" Width="100%">
    <div class="auto-style89">
           <strong>
           <asp:Label ID="Label10" runat="server" BackColor="#9900CC" CssClass="auto-style7" ForeColor="Wheat" Height="54px" style="background-color: #FF0000; font-size: large;" Text="Feedback/Queries" Width="748px"></asp:Label>
           <br />
           <br />
           </strong>
       </div>
        ...
        &nbsp;<asp:Label ID="Label12" runat="server" Width="279px"
               ...
               <tr style="text-align:center">
                   ...
                   <td style="text-align:center"><asp:TextBox ID="TextBox1" runat="server" Width="250px"  ></asp:TextBox> 
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="TextBox1" Display="Dynamic" ErrorMessage="Subject Required"></asp:RequiredFieldValidator>
                       <br />
                       <br />
                   </td> 
               </tr>
               <tr style="text-align:center">
                   ...
                   <td> <asp:TextBox ID="TextBox4" runat="server" Height="81px" TextMode="MultiLine" Width="250px" ></asp:TextBox>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="TextBox4" Display="Dynamic" ErrorMessage="Description Required"></asp:RequiredFieldValidator>
                       <br />
                       <br />
                   </td>
